    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/admin/temp/seed-develop-data").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/admin/result-duration/dispatch-queues").hasAnyRole(ADMIN)
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/clubs/interviews/**").hasAnyRole(CLUB_LEADER, CLUB_MEMBER)
                        ...
                        .requestMatchers(HttpMethod.GET, "/onepager/forms/**").hasAnyRole(CLUB_LEADER, CLUB_MEMBER)
